...
//                 git branch: 'main', url: 'https://github.com/alfabarry29/devops-fully-automated-infra.git'
//                 sh 'ls'
//             }
//         }
...
pipeline {
    ...
    environment {
        ...
        PROJECT_NAME = "app-infra-pipeline"
    }
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                // Single checkout step for the main branch
                checkout([$class: 'GitSCM',
                    branches: [[name: '*/main']],
                    doGenerateSubmoduleConfigurations: false,
                    extensions: [],
                    userRemoteConfigs: [[
                        url: 'https://github.com/alfabarry29/devops-fully-automated-infra.git'
                        If private repo, add: credentialsId: 'slack-token'
                    ]]
                ])
            }
        }
